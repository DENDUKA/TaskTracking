...
var nicEditorConfig = bkClass.extend({
  buttons: {
    ...
    iconsPath: '/TaskTracking/Scripts/NicEdit/nicEditorIcons.gif',
...
//nicEditors.registerPlugin(nicPlugin, nicImageOptions); //Commented
...
//nicEditors.registerPlugin(nicPlugin, nicUploadOptions);//commented
